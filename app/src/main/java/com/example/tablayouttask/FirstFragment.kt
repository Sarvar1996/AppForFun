...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        foodlist.add(Food("Coffee", R.drawable.fries,"Coffee preparation is the process of turning coffee beans into a beverage." +
        ...
        foodlist.add(Food("Espersso", R.drawable.burger,"Coffee preparation is the process of turning coffee beans into a beverage." +
                " While the particular steps vary with the type of coffee and with the raw materials, the process includes four basic steps; raw coffee " +
                "beans must be roasted, the roasted coffee beans must then be ground, the ground coffee must then be mixed with hot water for a certain " +
                "time (brewed), and finally the liquid coffee must be separated from the used grounds."))
        foodlist.add(Food("French Fires", R.drawable.burger,"Coffee preparation is the process of turning coffee beans into a beverage." +
                " While the particular steps vary with the type of coffee and with the raw materials, the process includes four basic steps; raw coffee " +
                "beans must be roasted, the roasted coffee beans must then be ground, the ground coffee must then be mixed with hot water for a certain " +
                "time (brewed), and finally the liquid coffee must be separated from the used grounds."))
        foodlist.add(Food("Honey",R.drawable.fries,"Coffee preparation is the process of turning coffee beans into a beverage." +
                " While the particular steps vary with the type of coffee and with the raw materials, the process includes four basic steps; raw coffee " +
                "beans must be roasted, the roasted coffee beans must then be ground, the ground coffee must then be mixed with hot water for a certain " +
                "time (brewed), and finally the liquid coffee must be separated from the used grounds."))
        foodlist.add(Food("Coffee", R.drawable.fries,"Coffee preparation is the process of turning coffee beans into a beverage." +
